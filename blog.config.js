...
const BLOG = {
  AUTHOR: '镜像', // 作者
  BIO: '一个普通的打工人🍚', // 作者简介
  LINK: 'https://blog.feidao158.site', // 网站地址
  KEYWORDS: 'code', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  ...
  CONTACT_EMAIL: 'jkfeidao@gmail.com', // 邮箱
  CONTACT_WEIBO: '', // 你的微博个人主页
  CONTACT_TWITTER: '', // 你的twitter个人主页
  CONTACT_GITHUB: 'https://github.com/feidao158', // 你的github个人主页
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || '镜像 BLOG', // 站点标题 ，被notion中的页面标题覆盖
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '记录美好生活~', // 站点描述，被notion中的页面描述覆盖
